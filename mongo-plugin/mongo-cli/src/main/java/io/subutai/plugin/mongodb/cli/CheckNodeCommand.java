...
@Command( scope = "mongo", name = "check-node", description = "Checks node" )
public class CheckNodeCommand extends OsgiCommandSupport
{
    ...
    {
        UUID uuid = getMongoManager().checkNode( clusterName, hostname, NodeType.valueOf( nodeType ) );
