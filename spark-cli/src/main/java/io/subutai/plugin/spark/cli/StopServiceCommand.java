...
/**
 * sample command :
 *      spark:stop-node test \ {cluster name}
...
public class StopServiceCommand extends OsgiCommandSupport
{
    ...
    protected Object doExecute() throws IOException
    {
        ...
        UUID uuid = sparkManager.stopNode( clusterName, hostname, CheckAllNodesCommand.isMaster( config, hostname, environmentManager ) );
