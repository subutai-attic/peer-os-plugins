...
public class MongoAlertListener extends ExceededQuotaAlertHandler
{
            ...
            throws AlertHandlerException
    {
        ...
        try
        {
            ...
            double currentValue =
                    exceededQuota.getCurrentValue( ByteValueResource.class ).getValue( ByteUnit.BYTE ).doubleValue();
            double ramLimit = currentValue * ( thresholds.getRamAlertThreshold() / 100 ); // 0.8
            double redLine = 0.9;
