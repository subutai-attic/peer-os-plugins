package io.subutai.plugin.elasticsearch.ui.manager;
...
public class Manager
{
    ...
    public Manager( final ExecutorService executorService, final Elasticsearch elasticsearch, Tracker tracker,
