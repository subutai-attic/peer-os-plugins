...
public class ManageContainersStep extends Panel
{
                                ...
                                final Profile currentProfile )
    {
        ...
        for ( final ContainerHost host : hosts )
        {
            ...
            containerTable.addItem( new Object[] {
                    host.getHostname(), operationSelect, executeBtn
            }, null );
...
//            addClickListenerToExecuteButton( executeBtn, host, ( Operation ) operationSelect.getValue() );
    ...
    {
        getButton( EXECUTE_BUTTON_CAPTION, executeBtn ).addClickListener( new Button.ClickListener()
        {
            @Override
