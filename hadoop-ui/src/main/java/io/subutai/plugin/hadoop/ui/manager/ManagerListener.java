 ...
 *  
 */
package io.subutai.plugin.hadoop.ui.manager;
...
import io.subutai.plugin.hadoop.api.CheckDecommissionStatusTask;
import io.subutai.plugin.hadoop.api.HadoopClusterConfig;
import io.subutai.plugin.hadoop.api.HadoopNodeOperationTask;
    ...
    private void checkDecommissioningStatus( final Item row, final Button checkButton )
    {
        hadoopManager.getExecutorService().execute(
                new CheckDecommissionStatusTask( hadoopManager.getHadoop(), hadoopManager.getTracker(),
                        hadoopManager.getHadoopCluster(), new io.subutai.plugin.hadoop.api.CompleteEvent()
                {
