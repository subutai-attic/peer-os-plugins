...
import io.subutai.plugin.hadoop.ui.HadoopPortalModule;
...
public class WelcomeStep extends VerticalLayout
{
    ...
    public WelcomeStep( final EnvironmentWizard wizard )
    {
        ...
        Label welcomeMsg = new Label( "<center><h2>Welcome to Hadoop Configuration Wizard!</h2>" );
