...
public class ClusterOperationHandlerTest
{
    ...
    public void setUp()
    {
        ...
        when( hiveImpl.getEnvironmentManager().getEnvironmentByUUID( hadoopClusterConfig.getEnvironmentId() ) )
    ...
    {
        AbstractOperationHandler operationHandler =
                new ClusterOperationHandler( hiveImpl, hiveConfig, hadoopClusterConfig,
