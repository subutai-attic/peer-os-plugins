package io.subutai.plugin.spark.ui.manager;
...
public class AddNodeWindow extends Window
{
    ...
    public AddNodeWindow( final Executor executor, final Spark spark, final Tracker tracker,
                          final SparkClusterConfig config, Set<EnvironmentContainerHost> nodes )
    {
        super( "Add New Node" );
        setModal( true );
        ...
        addNodeBtn.addClickListener( new Button.ClickListener()
        {
            ...
            public void buttonClick( Button.ClickEvent clickEvent )
            {
                ...
                showProgress();
                EnvironmentContainerHost node = ( EnvironmentContainerHost ) hadoopNodes.getValue();
