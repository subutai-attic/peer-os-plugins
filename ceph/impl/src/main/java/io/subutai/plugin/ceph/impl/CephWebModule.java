...
public class CephWebModule implements WebuiModule
{
    ...
    private static String NAME = "Ceph";
    private static String IMG = "plugins/ceph/ceph.png";
    ...
    public void init()
    {
        ...
        AngularjsDependency angularjsDependency =
                new AngularjsDependency( "subutai.plugins.ceph", "plugins/ceph/ceph.js", "plugins/ceph/controller.js",
