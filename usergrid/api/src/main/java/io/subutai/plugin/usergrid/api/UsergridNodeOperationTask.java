...
public class UsergridNodeOperationTask extends AbstractNodeOperationTask implements Runnable
{
    ...
    private final UsergridInterface userGridInterface;
                                       ...
                                       ContainerHost containerHost )
    {
        ...
        this.userGridInterface = usergrid;
    ...
    public UUID runTask ()
    {
        ...
        switch ( operationType )
        {
            case START:
            {
                returnID = userGridInterface.startCluster ( clusterName );
                break;
            }
            case STOP:
            {
                returnID = userGridInterface.stopCluster ( clusterName );
                break;
            }
            case STATUS:
            {
                returnID = userGridInterface.statusCluster ( clusterName );
                break;
            }
        }
