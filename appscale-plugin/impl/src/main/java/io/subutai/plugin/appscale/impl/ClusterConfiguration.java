...
<<<<<<< HEAD
//        String addButton
//                = "<li align=\"center\" class=\"tab\"><a class=\"btn btn-info\" href=\"{{ flower_url }}\">TaskQueue "
//                + "Monitor<\\/a><\\/li>";
//        String replaceString = addButton
//                + "<br><li align=\"center\" class=\"tab\"><a class=\"btn btn-info\" href=\"#\"  "
//                + "onClick=\"growEnvironment()\">Add Appengine<\\/a><\\/li>";
//        this.commandExecute ( containerHost, "sed -i 's/ " + addButton + "/" + replaceString
...
=======
        ...
        String replaceString =
                addButton + "<br><li align=\"center\" class=\"tab\"><a class=\"btn btn-info\" href=\"#\"  "
                        + "onClick=\"growEnvironment()\">Add Appengine<\\/a><\\/li>";
        this.commandExecute( containerHost, "sed -i 's/ " + addButton + "/" + replaceString
                + "/g' /root/appscale/AppDashboard/templates/shared/navigation.html" );
        String changeMonitURL = "sed -i 's/{{ monit_url }}/http:\\/\\/2812." + config.getUserDomain()
>>>>>>> 59175acdb6ad4d81b539f4903a3b96674673b1e0
                + "/g' /root/appscale/AppDashboard/templates/shared/navigation.html";
