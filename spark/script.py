...
command += "&& scp " + plugin + "-api/target/" + plugin + "-plugin-api-4.0.0-RC12.jar " + plugin + "-cli/target/" + \
		   plugin + "-plugin-cli-4.0.0-RC12.jar " + plugin + "-impl/target/" + plugin + "-plugin-impl-4.0.0-RC12.jar " \
		   + plugin + "-rest/target/" + plugin + "-plugin-rest-4.0.0-RC12.jar "
