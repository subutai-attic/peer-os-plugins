...
//
//
//    public Set<MongoDataNode> getDataHosts()
//    {
//        return dataNodes;
//    }
//
//
//    public void setDataHosts( Set<MongoDataNode> dataNodes )
//    {
...
//        {
//            case DATA_NODE:
//                getDataHosts().add( ( MongoDataNode ) host );
...
//        }
//        else if ( getDataHosts().contains( node ) )
//        {
...
//    {
//        String primaryNodeName = getDataHosts().iterator().next().getPrimaryNodeName();
//
...
//
//    @Override
//    public void setConfigHosts( Set<UUID> configServerNames )
//    {
...
//
//    @Override
//    public void setRouterHosts( Set<UUID> routerServerNames )
//    {
//        this.routerHostIds.clear();
